          ...
          <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700 shadow-lg">
            <CardContent className="pt-6">
              <p className="text-lg text-gray-300">
                bit0git is an open-source initiative dedicated to making version control accessible to everyone. We believe that understanding Git is essential for modern development, and our mission is to provide high-quality learning resources to make this happen.
              </p>
            </CardContent>
          </Card>
        </motion.section>
