...
import { BookOpen, GitBranch, GitCommit, GitMerge, GitPullRequest, Trophy } from 'lucide-react';
              ...
              <motion.div variants={cardVariants} initial="hidden" animate="visible" transition={{ duration: 0.5, delay: 0.3 }}>
                <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700 shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button asChild variant="outline" className="w-full mt-4 border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-gray-100">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button asChild size="lg" className="bg-purple-500 hover:bg-purple-600 text-white">
              <Link href="/git-game">Try the Interactive Git Game</Link>
            </Button>
          </div>
        </motion.div>
      </div>
